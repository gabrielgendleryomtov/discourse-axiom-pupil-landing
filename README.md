...
## Features
- Redirect configured pupils from homepage routes to `/pupil-landing`.
...
## Settings
- `axiom_pupil_landing_enabled` (default: true)
- `axiom_pupil_landing_pupil_groups` (default: "", accepts multiple groups)
